package com.gaven.mission7.service;

import com.gaven.mission7.exception.EntityNotFoundException;
import com.gaven.mission7.Status;
import com.gaven.mission7.assembler.PurchaseModelAssembler;
...
public class PurchaseService {
    ...
    public CollectionModel<EntityModel<Purchase>> viewPurchases() {
        ...
        return new CollectionModel<>(purchases,
                linkTo(methodOn(PurchaseController.class).viewPurchases(0)).withSelfRel());
    }
